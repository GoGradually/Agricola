...
class TestWood3:
    ...
    def setup(self):
        ...
        player = 0
        player_status_repository.get_player_status()[player].resource.wood = 0
        game_status_repository.get_game_status().basic_resource[BasicBehaviorType.WOOD3.value] = 3
    ...
    def test_execute_success(self, setup):
        ...
        assert result == True
        assert player_status_repository.get_player_status()[player].resource.wood == 3
        assert wood3_action.log() == "나무 3개를 획득하였습니다."
        assert game_status_repository.get_game_status().basic_resource[BasicBehaviorType.WOOD3.value] == 0
    ...
    def test_execute_already_filled(self, setup):
        ...
        result = wood3_action.execute()
        assert result == False
        assert player_status_repository.get_player_status()[player].resource.wood == 0
