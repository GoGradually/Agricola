...
class MeetingPlace(BehaviorInterface):
    def __init__(self):
        ...
        self.is_filled = round_status_repository.round_status_repository.round_status.put_basic[BasicBehaviorType.MEETING.value]

    def can_play(self):
        return True

    def execute(self):
        for player in player_status_repository.player_status_repository.player_status:  # 기존 1등 선마커 뺏기
