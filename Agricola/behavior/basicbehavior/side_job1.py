...
class SideJob1(BehaviorInterface):
    ...
    def __init__(self):
        ...
        self.player_ownCard = player_status_repository.player_status_repository.player_status[player].own_card
        self.is_filled = round_status_repository.round_status_repository.round_status.put_basic[BasicBehaviorType.SIDE_JOB1.value]
