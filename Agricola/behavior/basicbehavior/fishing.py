...
class Fishing(BehaviorInterface):
    def __init__(self):
        self.log_text = ""
        player = player_status_repository.player_status_repository.player_status[game_status_repository.game_status_repository.game_status.now_turn_player]
        ...
        self.is_filled = round_status_repository.round_status_repository.round_status.put_basic[BasicBehaviorType.FISHING.value]
