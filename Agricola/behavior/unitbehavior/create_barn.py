...
class CreateBarn(Command):
    ...
    def execute(self):
        if isinstance(self.field_status[self.position[0]][self.position[1]], NoneField):
            ...
            player_status_repository.player_status_repository.player_status[game_status_repository.game_status_repository.game_status.now_turn_player].farm.field[self.position[0]][self.position[1]] \
