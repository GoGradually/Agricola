...
class CreateCage(Command):
    ...
    def execute(self):
        ...
        if not AnimalPositionValidation(field_status).execute():
            ...
            return False
        player_status_repository.player_status_repository.player_status[game_status_repository.game_status_repository.game_status.now_turn_player].farm.field = field_status
        player_status_repository.player_status_repository.player_status[game_status_repository.game_status_repository.game_status.now_turn_player].farm.horizon_fence = self.horizontal_fence
        player_status_repository.player_status_repository.player_status[game_status_repository.game_status_repository.game_status.now_turn_player].farm.vertical_fence = self.vertical_fence
        self.log_text = "건설 성공"
        return True
