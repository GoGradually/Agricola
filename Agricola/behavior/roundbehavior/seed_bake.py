...
class SeedBake(BehaviorInterface):
    ...
    def execute(self):
        ret = [SeedPlant]
        if player_status_repository.player_status_repository.player_status[game_status_repository.game_status_repository.game_status.now_turn_player].card.put_main_card:
            ret.append(DoBake)
