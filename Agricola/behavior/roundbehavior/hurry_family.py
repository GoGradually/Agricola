...
class HurryFamily(BehaviorInterface):
    ...
    def __init__(self, player):
        self.log_text = ""
        self.player_status = player_status_repository.player_status_repository.player_status[player]
        self.is_filled = round_status_repository.round_status_repository.round_status.put_basic[RoundBehaviorType.HURRY_FAMILY.value]
    ...
    def execute(self):
        self.player_status.set_baby(player_status_repository.player_status_repository.player_status[game_status_repository.game_status_repository.game_status.now_turn_player].baby + 1)
