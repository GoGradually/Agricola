...
class ConstructBarn(BaseBehaviorInterface):
    ...
    def execute(self):
        ...
        if barn_cnt >= 4 or selected_field_type != FieldType.CAGE:
            ...
            return False
        elif player_status_repository.player_status_repository.player_status[game_status_repository.game_status_repository.game_status.now_turn_player].resource.wood < 2:
            ...
            player_status_repository.player_status_repository.player_status[game_status_repository.game_status_repository.game_status.now_turn_player].resource.wood -= 2
            return True
