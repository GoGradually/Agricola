...
class HouseUpgrade(Command):
    def __init__(self):
        ...
        self.player_house = player_status_repository.player_status_repository.player_status[player].farm.house_status
        self.player_resource = player_status_repository.player_status_repository.player_status[player].resource
        self.player_houseNum = player_status_repository.player_status_repository.player_status[player].farm.get_house_count()
        self.log_text = ""
