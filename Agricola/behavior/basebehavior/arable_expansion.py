...
class ArableExpansion(BaseBehaviorInterface):
    ...
    def execute(self):
        ...
        if check_validation.execute():
            ...
            player_repo.player_status_repository.player_status_repository.player_status[game_status_repository.game_status_repository.game_status_repository.game_status.now_turn_player].farm.field = self.field_status
            return True
        else:
